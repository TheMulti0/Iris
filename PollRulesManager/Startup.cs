...
namespace PollRulesManager
{
    public class Startup
    {
        ...
        {
            var consumerConfig = Configuration.GetSection<RabbitMqConfig>("PollRequestsProducer"); 
            var producerConfig = Configuration.GetSection<RabbitMqConfig>("ChatPollRequestsConsumer");
